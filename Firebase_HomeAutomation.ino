...
#define FIREBASE_AUTH "ZNxOKbjyaBnjNyhESNLCa6ixxRRMY6nL0HMU53Y9"       //Your Firebase Database Secret goes here
...
void setup() 
{
  ...
  Firebase.setString("S1","1");                     //Here the varialbe"S1","S2","S3" and "S4" needs to be the one which is used in our Firebase and MIT App Inventor
...
void loop() 
{
  ...
  //Firebase.get("/FwJmI8JmppMITms75sTBiUA6cKD2").getString("waterNow")
      
  val1=Firebase.getString("S1").toInt();                                        //Reading the value of the varialble Status from the firebase
  String val11=Firebase.get("/FwJmI8JmppMITms75sTBiUA6cKD2").getString("waterNow"); 
  Serial.println("val1: "+ val11);
